...
"""
    ...
    on some common1 HTTP errors such as non-empty responses for 304 status
    codes.

    This module provides a middleware, the :class:`LintMiddleware`.  Wrap your
    application with it and it will warn about common1 problems with WSGI and
...
class LintMiddleware(object):
    ...
    """This middleware wraps an application and warns on common1 errors.
